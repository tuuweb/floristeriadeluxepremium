...
INSERT INTO public.site_settings (key, value) VALUES
  ...
  ('email','hola@floristeriadeluxe.com'),
  ('address','Calle 93 #13-45, Bogotá'),
  ('shipping_cop','18000'),
...
INSERT INTO public.products (name, slug, description, price_cop, images, category_id, is_featured, stock, tags, sort_order)
SELECT 'Rose Dorée Intimité','rose-doree-intimite','Rosas jardín rosadas con velas y detalles dorados para una noche íntima.',298000,ARRAY['/img/hero-03.jpg'],c.id,false,14,ARRAY['romance','velas'],8 FROM public.categories c WHERE c.slug='amor';